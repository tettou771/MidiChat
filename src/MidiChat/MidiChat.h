...
t:4,4,4
b:100
M:C5q,E,G,B|C,E,G,B|C,E,G,B|C,E,G,B
B:C2q,C2,C2,C2|C2,C2,C2,C2|D2,D2,D2,D2|D2i,R,D2,R,D2,R,D2,R
C:Cmajq,Dmi,Em,Fmaj|Gmaj,Ami,Bmi,Cmaj|Dmi,Em,Fmaj,Gmaj|Ami,Bmi,Cmaj,Dmi
P:C2f,D2,R,R|C2,D2,R,R|C2,D2,R,R|C2,D2,R,R
```
このメロディーは、4/4拍子で構成され、BPMは100で演奏されます。メロディーは、高音域のC、E、G、Bの音を順番に4分音符で演奏し、3小節繰り返されます。4小説目は8分音符を使っています。
次に、コード進行が加わり、C、D、E、F、G、A、Bの和音が1小節ずつ演奏されます。最後に、パーカッションが加わり、ベースドラム(C2)とスネアドラム(D2)が2ビートずつ演奏されます。
